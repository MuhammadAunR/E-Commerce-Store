                ...
                <section className='bg-secondary h-fit py-7 rounded-2xl'>
                    ...
                    <div className="flex flex-col gap-4 px-5 md:px-20 mt-5">
                        <div className="grid grid-cols-1 md:grid md:grid-cols-2 lg:grid lg:grid-cols-[1fr_2fr] gap-4 ">
                            <div className="bg-white rounded-2xl h-64 overflow-hidden relative">
                                <span className='absolute top-5 left-5 font-bold font-body text-3xl z-10'>Casual</span>
                                <Image
                                    src="/casual-dressing.jpg"
                                    alt="Casual Dressing"
                                    fill
                                    className="object-cover w-full h-full transition-transform hover:scale-105 duration-300 ease-in-out"
                                />
                            </div>
                            <div className="bg-white rounded-2xl h-64 overflow-hidden relative">
                                ...
                                <Image
                                    ...
                                    alt="Formal Dressing"
                                    fill
                                    className="object-cover w-full h-full transition-transform hover:scale-105 duration-300 ease-in-out object-top"
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid md:grid-cols-2 lg:grid lg:grid-cols-[2fr_1fr] gap-4">
                            ...
                            <div className="bg-white rounded-2xl h-64 overflow-hidden relative">
                                ...
                                <Image
                                    ...
                                    alt="Gym Dressing"
                                    fill
                                    className="object-cover w-full h-full transition-transform hover:scale-105 duration-300 ease-in-out object-bottom"
                                />
                            </div>
                        </div>
                    </div>
